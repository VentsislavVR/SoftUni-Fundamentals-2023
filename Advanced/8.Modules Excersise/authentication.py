...
def render_entry():
    register_button = Button(
        ...
        bg="green",
        fg="white",
        borderwidth=0,  # font ,разер шрифт и т.н
        width=20,
        height=3,
        command=register
...
def register():
    ...
    frame.create_text(100, 200, text="Password: ")  # repeat pass confirmation
    ...
    frame.create_window(200, 200, window=password_box)  # hide or unhide pass
...
def registration():
    ...
    if check_registration(info_dict):
        with open("db/user_information.txt", "a") as users_file:
...
password_box = Entry(root, bd=0, show="*")  # hide or unhide pass
